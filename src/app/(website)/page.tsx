...
export default function Home() {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)
  const [currentImageStyle, setCurrentImageStyle] = useState("floating")
  ...
  const IMAGE_STYLES = [
    { id: "floating", name: "Floating Overlap" },
    { id: "cascading", name: "Cascading Cards" },
    { id: "mosaic", name: "Mosaic Grid" },
    { id: "circular", name: "Circular" },
    { id: "perspective", name: "3D Perspective" },
    { id: "diagonal", name: "Diagonal" },
    { id: "hexagon", name: "Hexagonal" },
  ]

  const renderImageStyle = () => {
    switch(currentImageStyle) {
      case "floating":
        return (
          <div className="relative flex items-center justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="relative group w-full max-w-lg lg:max-w-none">
              <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-primary/20 to-blue-500/20 rounded-xl sm:rounded-2xl blur-lg sm:blur-xl group-hover:blur-2xl transition-all duration-500 opacity-70" />
              <div className="relative bg-background/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-border/50 shadow-xl sm:shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 p-1.5 sm:p-2">
                <Image src="/eight.png" alt="Main Dashboard" width={600} height={400} className="rounded-lg sm:rounded-xl w-full h-auto" />
              </div>
            </div>
            <div className="hidden lg:block absolute -top-16 -left-20 xl:-left-28 z-10">
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl blur-lg group-hover:blur-xl transition-all duration-300 opacity-60" />
                <div className="relative bg-background/90 backdrop-blur-sm rounded-xl border border-border/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 p-1.5 hover:rotate-2">
                  <Image src="/eleven.png" alt="DM Automation" width={300} height={200} className="rounded-lg" />
                </div>
              </div>
            </div>
            <div className="hidden lg:block absolute -bottom-20 -right-16 xl:-right-24 z-10">
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl blur-lg group-hover:blur-xl transition-all duration-300 opacity-60" />
                <div className="relative bg-background/90 backdrop-blur-sm rounded-xl border border-border/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 p-1.5 hover:-rotate-2">
                  <Image src="/six.png" alt="Lead Qualification" width={280} height={180} className="rounded-lg" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center mt-8 lg:mt-0">
            <div className="relative">
              <div className="absolute top-8 left-8 transform rotate-6 opacity-70">
                <div className="bg-background/80 rounded-xl border shadow-lg p-2">
                  <Image src="/three.png" alt="Background" width={400} height={250} className="rounded-lg" />
                </div>
              </div>
              <div className="absolute top-4 left-4 transform rotate-3 opacity-85">
                <div className="bg-background/85 rounded-xl border shadow-xl p-2">
                  <Image src="/two.png" alt="Middle" width={420} height={260} className="rounded-lg" />
                </div>
              </div>
              <div className="relative z-10">
                <div className="bg-background rounded-xl border shadow-2xl p-2">
                  <Image src="/eight.png" alt="Front" width={450} height={280} className="rounded-lg" />
                </div>
              </div>
            </div>
          </div>
      ...
      case "mosaic":
        return (
          <div className="relative mt-8 lg:mt-0">
            <div className="grid grid-cols-6 grid-rows-4 gap-2 h-80 lg:h-96">
              <div className="col-span-3 row-span-2 rounded-xl overflow-hidden shadow-lg">
                <Image src="/eight.png" alt="Large" width={600} height={400} className="w-full h-full object-cover" />
              </div>
              <div className="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
                <Image src="/three.png" alt="Medium" width={400} height={400} className="w-full h-full object-cover" />
              </div>
              <div className="col-span-1 row-span-1 rounded-xl overflow-hidden shadow-lg">
                <Image src="/six.png" alt="Small 1" width={200} height={200} className="w-full h-full object-cover" />
              </div>
              <div className="col-span-1 row-span-1 rounded-xl overflow-hidden shadow-lg">
                <Image src="/eleven.png" alt="Small 2" width={200} height={200} className="w-full h-full object-cover" />
              </div>
              <div className="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-lg">
                <Image src="/two.png" alt="Tall" width={400} height={500} className="w-full h-full object-cover" />
              </div>
              <div className="col-span-3 row-span-1 rounded-xl overflow-hidden shadow-lg">
                <Image src="/ten.png" alt="Wide" width={600} height={200} className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        )
          ...
          <div className="relative mt-8 lg:mt-0 flex justify-center">
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full overflow-hidden border-4 border-primary shadow-xl">
                  <Image src="/eight.png" alt="Center" width={128} height={128} className="w-full h-full object-cover" />
                </div>
              </div>
              {["/three.png", "/two.png", "/six.png", "/eleven.png", "/ten.png"].map((src, i) => {
                const angle = (i * 72) * Math.PI / 180;
                const radius = 100;
                const x = Math.cos(angle) * radius;
                const y = Math.sin(angle) * radius;
                return (
                  <div key={i} className="absolute top-1/2 left-1/2 w-16 h-16 lg:w-20 lg:h-20" 
                       style={{ transform: `translate(${x - 32}px, ${y - 32}px)` }}>
                    <div className="w-full h-full rounded-full overflow-hidden border-2 border-border shadow-lg hover:scale-110 transition-transform">
                      <Image src={src} alt={`Circle ${i}`} width={80} height={80} className="w-full h-full object-cover" />
                    </div>
                  </div>
                );
              })}
      ...
      case "perspective":
        return (
          <div className="relative mt-8 lg:mt-0 flex justify-center items-end space-x-4" style={{ perspective: "1000px" }}>
            <div className="transform rotate-y-12 hover:rotate-y-6 transition-transform duration-500">
              <div className="bg-background rounded-xl border shadow-xl p-2">
                <Image src="/three.png" alt="Left" width={250} height={160} className="rounded-lg" />
              </div>
            </div>
            <div className="transform scale-110 z-10">
              <div className="bg-background rounded-xl border shadow-2xl p-2">
                <Image src="/eight.png" alt="Center" width={350} height={220} className="rounded-lg" />
              </div>
            </div>
            <div className="transform -rotate-y-12 hover:-rotate-y-6 transition-transform duration-500">
              <div className="bg-background rounded-xl border shadow-xl p-2">
                <Image src="/two.png" alt="Right" width={250} height={160} className="rounded-lg" />
              </div>
            </div>
          </div>
        )
      ...
      case "diagonal":
        return (
          <div className="relative mt-8 lg:mt-0 h-80 lg:h-96">
            {["/eight.png", "/three.png", "/two.png", "/six.png"].map((src, i) => (
              <div key={i} className={`absolute rounded-xl overflow-hidden shadow-lg border-2 border-background`}
                   style={{
                     top: `${i * 50}px`,
                     left: `${i * 60}px`,
                     width: `${250 - i * 15}px`,
                ...
                <Image src={src} alt={`Diagonal ${i}`} width={250} height={160} className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
        )
      ...
      case "hexagon":
        return (
          <div className="relative mt-8 lg:mt-0 flex justify-center items-center h-80 lg:h-96">
            <div className="grid grid-cols-3 gap-4">
              <div className="col-start-2">
                <div className="w-20 h-20 lg:w-24 lg:h-24 clip-hexagon bg-background shadow-lg overflow-hidden">
                  <Image src="/eight.png" alt="Hex 1" width={96} height={96} className="w-full h-full object-cover scale-110" />
                </div>
              </div>
              <div className="w-20 h-20 lg:w-24 lg:h-24 clip-hexagon bg-background shadow-lg overflow-hidden">
                <Image src="/three.png" alt="Hex 2" width={96} height={96} className="w-full h-full object-cover scale-110" />
              </div>
              <div className="w-28 h-28 lg:w-32 lg:h-32 clip-hexagon bg-background shadow-xl overflow-hidden border-2 border-primary">
                <Image src="/two.png" alt="Hex Center" width={128} height={128} className="w-full h-full object-cover scale-110" />
              </div>
              <div className="w-20 h-20 lg:w-24 lg:h-24 clip-hexagon bg-background shadow-lg overflow-hidden">
                <Image src="/six.png" alt="Hex 3" width={96} height={96} className="w-full h-full object-cover scale-110" />
              </div>
              <div className="col-start-2">
                <div className="w-20 h-20 lg:w-24 lg:h-24 clip-hexagon bg-background shadow-lg overflow-hidden">
                  <Image src="/eleven.png" alt="Hex 4" width={96} height={96} className="w-full h-full object-cover scale-110" />
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="flex min-h-screen flex-col dark">
        ...
        <section className="relative overflow-hidden py-12 sm:py-16 md:py-20 lg:py-32">
          ...
          <div className="container relative px-4 sm:px-6">
            <div className="grid gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                <div className="hidden lg:flex items-center gap-2 pt-4">
                  ...
                  <div className="flex gap-1">
                    {IMAGE_STYLES.map((style) => (
                      <Button
                        key={style.id}
                        variant={currentImageStyle === style.id ? "default" : "outline"}
                        size="sm"
                        onClick={() => setCurrentImageStyle(style.id)}
              ...
              {/* Visual Side - Dynamic Image Styles */}
              {renderImageStyle()}
            </div>
          </div>
        </section>
      ...
      {/* Custom CSS for 3D transforms and hexagon clipping */}
      <style jsx>{`
        .clip-hexagon {
