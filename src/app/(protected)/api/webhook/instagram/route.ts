...
//       // Add customer message to handoff conversation
//       const handoffStatus = await getHandoffStatus(pageId, senderId)
//       if (handoffStatus) {
//         // Find the active handoff
...
//           // Message will be handled by agent - no auto-response needed
...
//     let voiceflowResponse: VoiceflowResponseWithButtons = {
//       text: "Just give me a moment, I am checking something.",
//       buttons: undefined,
//     }
//     let voiceflowVariables: VoiceflowVariables = {}
...
//     const fallbackText = "Just give me a moment, I am checking something."
...
//Again the above one works but we use this for the non-keywords trigger
