...
//             value={formData.businessDescription}
//             onChange={(e) => handleInputChange('businessDescription', e.target.value)}
//             className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-muted-foreground focus:border-sidebar-primary focus:ring-1 focus:ring-sidebar-primary transition-all h-32 resize-none"
//             placeholder="Tell us about your business, what you do, who your customers are, and what products/services you offer..."
//           />
