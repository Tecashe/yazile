                  ...
                  <div className="border-t pt-4">
                    <div className="flex items-center gap-2 mb-4">
                      <input
                        type="checkbox"
                        id="useVoiceflow"
                        checked={formData.useVoiceflow}
                        onChange={(e) => setFormData({ ...formData, useVoiceflow: e.target.checked })}
                      />
                      <Label htmlFor="useVoiceflow" className="cursor-pointer font-semibold">
                        Enable Voiceflow AI
                      </Label>
                    </div>

                    {formData.useVoiceflow && (
                      <div className="space-y-3 bg-muted p-3 rounded">
                        <div>
                          <Label htmlFor="voiceflowApiKey">Voiceflow API Key</Label>
                          <Input
                            id="voiceflowApiKey"
                            type="password"
                            value={formData.voiceflowApiKey}
                            onChange={(e) => setFormData({ ...formData, voiceflowApiKey: e.target.value })}
                            placeholder="Your Voiceflow API key"
                          />
                        </div>
                        <div>
                          <Label htmlFor="voiceflowBotId">Voiceflow Bot ID</Label>
                          <Input
                            id="voiceflowBotId"
                            value={formData.voiceflowBotId}
                            onChange={(e) => setFormData({ ...formData, voiceflowBotId: e.target.value })}
                            placeholder="Your Voiceflow Bot ID"
                          />
                        </div>
                      </div>
                    )}
