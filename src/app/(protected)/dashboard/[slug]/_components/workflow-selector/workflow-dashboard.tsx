    ...
    <div className="min-h-screen bg-background">
      <div className="radial--gradient--automations">
        <div className="max-w-6xl mx-auto p-6">
          ...
          <Card className="glassEffect border-2 border-primary/50 mb-8 p-2">
          ...
          <Card className="glassEffect border-2 border-border/50 mb-8">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center justify-center gap-2 text-primary">
                <BarChart className="h-6 w-6" />
          ...
          {/* Support & Contact */}
          <Card className="glassEffect border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-900/10 mb-8">
            <CardContent className="p-6">
