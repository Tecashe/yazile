...
const WorkflowPendingPage: React.FC<WorkflowPendingPageProps> = ({
  ...
  const getProgressPercentage = () => {
    ...
    const estimatedDays = parseInt(pendingWorkflowData.estimatedCompletion || "2")
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground mb-2">
              Our development team is building your custom workflow
            </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 bg-muted/50 rounded-lg">
                    <p className="text-lg font-semibold">
                      {formatDate(pendingWorkflowData.submittedAt).split(',')[0]}
                    </p>
          ...
          {/* Footer Note */}
          <div className="text-center mt-8 p-4 bg-muted/30 rounded-lg border border-border/50">
