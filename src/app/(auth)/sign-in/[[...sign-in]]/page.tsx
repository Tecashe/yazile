      ...
      <div className="w-full">
        <SignIn
          appearance={{
            elements: {
              formButtonPrimary:
                "bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl border-0",
              card: "bg-card/50 backdrop-blur-xl shadow-2xl border border-border/50 rounded-xl",
              headerTitle: "text-foreground font-bold",
              headerSubtitle: "text-muted-foreground",
              formFieldLabel: "text-foreground font-medium",
              formFieldInput:
                "bg-input border border-border focus:border-primary text-foreground placeholder:text-muted-foreground rounded-lg transition-all duration-200 backdrop-blur-sm focus:ring-2 focus:ring-ring",
              footerActionLink: "text-primary hover:text-primary/80 transition-colors",
              identityPreviewText: "text-foreground",
              identityPreviewEditButton: "text-primary hover:text-primary/80 transition-colors",
              formFieldInputShowPasswordButton: "text-muted-foreground hover:text-foreground transition-colors",
              ...
              formFieldError: "text-destructive",
              socialButtonsBlockButton:
                "border border-border hover:border-primary/50 bg-secondary hover:bg-secondary/80 transition-all duration-200 backdrop-blur-sm",
              socialButtonsBlockButtonText: "text-secondary-foreground font-medium",
              socialButtonsBlockButtonArrow: "text-muted-foreground",
              formFieldSuccessText: "text-chart-2",
              formFieldInfoText: "text-chart-1",
              formHeaderTitle: "text-foreground",
              formHeaderSubtitle: "text-muted-foreground",
              modalContent: "bg-background border border-border rounded-xl shadow-2xl",
              modalCloseButton: "text-muted-foreground hover:text-foreground",
              alternativeMethodsBlockButton:
                "border border-border hover:border-primary/50 bg-secondary hover:bg-secondary/80 text-secondary-foreground",
              alternativeMethodsBlockButtonText: "text-secondary-foreground",
              otpCodeFieldInput: "bg-input border border-border focus:border-primary text-foreground",
              formResendCodeLink: "text-primary hover:text-primary/80",
              formFieldAction: "text-primary hover:text-primary/80",
              formFieldHintText: "text-muted-foreground",
              formFieldSuccessIcon: "text-chart-2",
              formFieldErrorIcon: "text-destructive",
              formFieldWarningIcon: "text-destructive",
              formFieldInfoIcon: "text-chart-1",
            },
            layout: {
              socialButtonsPlacement: "bottom",
              showOptionalFields: false,
