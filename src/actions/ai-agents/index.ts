...
//     // Get user's tenant/business to find integrations
//     const business = await client.business.findFirst({
//       where: { userId: user.data.id },
//     })
...
//     // Note: This assumes you have an Integration model linked to tenant
//     // You may need to adjust based on your actual schema
//     const integrations =
//       (await client.integration?.findMany({
//         where: {
//           tenantId: business.userId || business.id, // Adjust based on your schema
//           isActive: true,
//         },
//         select: {
//           id: true,
...
//     return { status: 200, data: tenant.integrations }
//   } catch (error) {
//     console.error("Error fetching integrations:", error)
//     return { status: 500, data: [], error: "Failed to fetch integrations" }
//   }
