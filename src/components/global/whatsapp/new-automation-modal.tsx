...
export default function NewAutomationModal({ open, onClose, onSave }: NewAutomationModalProps) {
  const [name, setName] = useState("")
  const [trigger, setTrigger] = useState<Automation["trigger"]>("keyword")
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Create New WhatsApp Automation</DialogTitle>
