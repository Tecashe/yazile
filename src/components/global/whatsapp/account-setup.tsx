...
//       // Save the WhatsApp account to the database
...
//                   We will redirect you to Meta to authorize access to your WhatsApp Business account.
//                 </p>
//               </div>
//             </div>
//           )}
...
//                       {businessAccounts.find((acc) => acc.id === selectedBusinessAccount)?.name}
//                     </span>
//                   </li>
//                   <li className="flex justify-between">
//                     <span className="text-muted-foreground">WhatsApp Number:</span>
//                     <span className="font-medium">
//                       {phoneNumbers.find((phone) => phone.id === selectedPhoneNumber)?.display_phone_number}
//                     </span>
//                   </li>
//                   <li className="flex justify-between">
...
export default function AccountSetup() {
  ...
  const handleConnectMeta = () => {
    // Redirect to Meta OAuth flow
    const redirectUri = `${window.location.origin}/api/auth/meta-callback`
    const metaOAuthUrl = `https://www.facebook.com/v22.0/dialog/oauth?client_id=${process.env.NEXT_PUBLIC_META_APP_ID}&redirect_uri=${redirectUri}&scope=whatsapp_business_management,whatsapp_business_messaging`
