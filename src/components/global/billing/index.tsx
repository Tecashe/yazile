...
//     // For free plan, just activate it without payment
//     if (plan.id === "FREE") {
...
//       id: plan.id,
//       name: plan.name,
//       price: billingCycle === "monthly" ? plan.price.monthly : plan.price.annually,
//       billingCycle: billingCycle,
//       description: plan.description,
//     }

//     // Store plan details in session storage for payment page to access
...
//         description: "There was an error activating your free plan. Please try again.",
//         variant: "destructive",
//       })
//     }
//   }
...
//     if (
//       (teamSize === "small" && (useCase === "business" || importantFeature === "analytics")) ||
