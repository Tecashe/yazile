          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-text-secondary text-sm">
                {isAiResponse ? "Intelligent responses powered by AI" : "Template-based automated reply"}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-background-90 border-background-80/50">
              <CardContent className="p-5">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <MessageSquare className="h-5 w-5 text-[#768BDD]" />
                    <h4 className="font-semibold">Response Preview</h4>
                  </div>
                ...
                {/* Response Settings */}
                <div className="mt-4 pt-4 border-t border-background-80/50">
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <span className="font-medium text-sm">{isAiResponse ? "AI" : "Template"}</span>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-1 text-text-secondary text-xs mb-1">
                    ...
                    <div className="text-center">
                      ...
                      <span className="font-medium text-sm">{responseText.length} chars</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-background-90 border-background-80/50">
              <CardContent className="p-5">
                ...
                {/* AI-specific: Business Profile */}
                {isAiResponse && (
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <Info className="h-4 w-4 text-purple-400" />
                        <span className="text-sm font-medium">Business Knowledge Base</span>
                      </div>
                      {isLoadingProfile ? (
                    ...
                    {showBusinessProfile && businessProfile && (
                      <div className="bg-purple-500/10 rounded-lg p-3 mt-2 border border-purple-500/20">
                        <ScrollArea className="h-[100px]">
                          <p className="text-xs text-purple-200 whitespace-pre-wrap">{businessProfile}</p>
                        </ScrollArea>
                      </div>
                    )}
