...
const ThenNode = ({ id, theme = { id: "blue", name: "Blue", primary: "light-blue", secondary: "#768BDD" } }: Props) => {
  ...
  const hasPrompt = listener?.prompt && listener.prompt.trim().length > 0
  const hasCommentReply = listener?.commentReply && listener.commentReply.trim().length > 0
  const replyVariationsCount = listener?.commentReplyVariations?.length ?? 0
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText(listener?.prompt || "No response configured")
    setCopied(true)
    setTimeout(() => setCopied(false), 2000)
  }
    ...
    >
      ...
      <div className="bg-gradient-to-r from-background-80 to-background-90 rounded-2xl w-full overflow-hidden shadow-xl border border-background-80/50">
        ...
        <div className="p-6 sm:p-8 lg:p-10">
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8">
            <div className="p-4 bg-background-90 rounded-2xl shrink-0">{isSmartAI ? <SmartAi /> : <PlaneBlue />}</div>
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <h3 className="text-2xl sm:text-3xl font-bold">
                  {isSmartAI ? "AI-Powered Response" : "Automated Message"}
                </h3>
                <Badge className={`text-sm px-3 py-1 ${isSmartAI ? "bg-purple-600" : "bg-[#3352CC]"}`}>
                  {isSmartAI ? "AI" : "Auto"}
                </Badge>
              </div>
              <p className="text-text-secondary text-base sm:text-lg">
                ...
                <CardContent className="p-6 lg:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <FloatingPanel
                        ...
                        title="Edit Response Configuration"
                        className="max-w-[1400px]"
                      >
                        <ThenAction id={id} theme={theme} />
                      </FloatingPanel>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-base leading-relaxed whitespace-pre-line">
                          {listener?.prompt || "No message configured yet"}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-background-80/50 p-4 rounded-xl flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-text-secondary">Character Count</p>
                        <p className="font-semibold">{listener?.prompt?.length || 0} characters</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              {hasCommentReply && (
                <Card className="bg-background-90 border-background-80/50">
                  <CardContent className="p-6 lg:p-8">
                    ...
                    <div className="bg-background-80 rounded-xl p-5">
                      <p className="text-base leading-relaxed">{listener?.commentReply}</p>
                    </div>
                    {replyVariationsCount > 0 && (
                      <div className="mt-4">
                        <Badge variant="outline" className="bg-green-500/10 border-green-500/30 text-green-400">
                          <Sparkles className="h-3 w-3 mr-1" />
                          {replyVariationsCount} variations available
                        </Badge>
                      </div>
                    )}
                  </CardContent>
                ...
                <CardContent className="p-6 lg:p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-background-80 p-4 rounded-xl">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={isSmartAI ? "bg-purple-600" : "bg-[#3352CC]"}>
                          {isSmartAI ? "AI-Powered" : "Template"}
                        </Badge>
                      </div>
                    </div>
                    ...
                    {replyVariationsCount > 0 && (
                      <div className="bg-background-80 p-4 rounded-xl">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-semibold">{replyVariationsCount}</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-6">
                    <FloatingPanel
                      ...
                      title="Configure Response Action"
                      className="max-w-[1400px]"
                    >
                      <ThenAction id={id} theme={theme} />
                    </FloatingPanel>
