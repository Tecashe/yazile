...
//             Create a comprehensive profile of your business that will help AI understand and accurately represent your
...
//   // Example business profile for Scissors & Style salon
...
const ThenAction = ({
  ...
  // Your full example business profile content here...
  `

  // Template categories (placeholder, you'll have the full template categories)
  const templateCategories: TemplateCategory[] = [
    {
      id: "comprehensive",
      name: "Comprehensive",
      icon: <Briefcase className="h-3 w-3 mr-1" />,
      description: "Complete business profile templates",
      templates: [
        // Your templates would go here
        {
          id: "general-business",
          title: "General Business Profile",
          description: "Complete template for any business type",
          content: "# [Business Name] - Complete Business Profile\n\n## Business Overview\n...",
          tags: ["general", "all-purpose"],
        },
      ],
    },
    // Other categories would go here
  ]
