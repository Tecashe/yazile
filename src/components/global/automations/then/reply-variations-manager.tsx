...
export function ReplyVariationsManager({
  ...
  const handleRegenerateClick = (e: React.MouseEvent, index: number) => {
    e.stopPropagation()
    regenerateSingle(index)
  }

  const handleStartEditClick = (e: React.MouseEvent, index: number) => {
    e.stopPropagation()
    startEdit(index)
  }
                    ...
                    {editingIndex === index ? (
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-3 justify-end">
                          ...
                          <Button onClick={handleSaveEditClick} type="button" className="h-11 px-5">
                            <Check className="h-4 w-4 mr-2" />
                            Save
                          </Button>
                        </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          <Button
                            variant="ghost"
                            onClick={(e) => handleStartEditClick(e, index)}
                            type="button"
                            className="flex-1 sm:flex-none h-11"
                          >
                            <Edit2 className="h-4 w-4 mr-2" />
