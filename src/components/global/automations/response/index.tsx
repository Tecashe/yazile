...
//                 </p>
//                 <Button
//                   className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white"
...
//                         Get access to AI-powered templates and advanced features
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                     <div className="flex items-center gap-3">
//                       <RadioGroupItem id="monthly" value="monthly" checked className="text-purple-500" />
//                       <div>
...
//                 <div className="pt-2">
//                   <Button className="w-full bg-gradient-to-br from-purple-600 to-indigo-700 text-white py-6">
//                     Upgrade Now
//                   </Button>
...
//   const handleTabChange = (value: string) => {
//     if (value === "ai" && userSubscription !== "SMARTAI") {
//       // We'll handle this in the onClick of the tab trigger
//       return
//     }
...
//             description: "You now have access to AI-powered templates!",
//             duration: 5000,
//           })
//           // Simulate subscription update
//           // In a real app, this would come from your backend after payment
//           // userSubscription = "SMARTAI";
//         }}
//       />
//     </div>
...
//           {userSubscription === "SMARTAI" ? (
//             <>
//               <div className="bg-background-90 p-4 rounded-lg mb-4 border border-background-80">
//                 <div className="flex items-start gap-3">
...
//                       className={cn(
//                         "bg-background-90 p-3 rounded-lg border border-transparent transition-all cursor-pointer group",
//                         selectedTemplate === template.content && "border-blue-500 shadow-md",
//                       )}
//                       onClick={() => handleSelectTemplate(template)}
//                     >
//                       <div className="flex justify-between items-start mb-2">
...
//             </>
//           ) : (
//             <div className="bg-background-90 p-6 rounded-lg border border-background-80 text-center">
//               <div className="flex flex-col items-center justify-center">
//                 <div className="p-3 bg-background-80 rounded-full mb-4">
//                   <Lock className="h-6 w-6 text-blue-500" />
//                 </div>
//                 <h4 className="font-medium text-white text-lg mb-2">Pro Feature</h4>
//                 <p className="text-sm text-text-secondary mb-4 max-w-md">
//                   Upgrade to PRO to access AI-powered templates and create dynamic, personalized responses.
//                 </p>
//                 <Button className="bg-blue-600 text-white hover:bg-blue-700" onClick={handleUpgradeClick}>
//                   Upgrade to PRO
//                 </Button>
//               </div>
//             </div>
...
//             animate={{ opacity: 1, height: "auto" }}
//             exit={{ opacity: 0, height: 0 }}
//             className="mt-4 bg-background-90 p-4 rounded-lg border border-background-80"
//           >
//             <div className="flex items-center justify-between mb-3">
//               <h4 className="font-medium flex items-center gap-2">
//                 <Edit className="h-4 w-4 text-[#768BDD]" />
...
//           >
//             <div className="bg-black text-white px-6 py-4 rounded-lg shadow-lg border border-gray-800 pointer-events-auto">
//               <div className="flex items-center gap-3">
...
//                 <div>
//                   <h4 className="font-medium">Pro Feature</h4>
//                   <p className="text-sm text-gray-300">Upgrade to PRO to use AI-powered templates</p>
//                 </div>
//               </div>
//             </div>
//           </motion.div>
...
// components/response-library.tsx
"use client"
...
import { useState, useEffect } from "react"
import { motion, AnimatePresence } from "framer-motion"
import { MessageSquare, Sparkles, Star, StarOff, Copy, CheckCircle, Search, Tag, Clock, TrendingUp, Heart, Zap, Edit, Plus, Lock } from 'lucide-react'
import { cn } from "@/lib/utils"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Badge } from "@/components/ui/badge"
...
const ResponseLibrary = ({ isAI, onSelectTemplate, selectedTemplate }: Props) => {
  ...
  // Use the feature access hook instead of a prop
  const { isPro, isLoading } = useFeatureAccess()
  
  // Set active tab based on isPro status
  ...
  const handlePaymentSuccess = () => {
    ...
    // In a real app, the subscription context would be updated automatically
    // via the webhook, but we can trigger a refresh here just to be sure
    window.location.reload()
  }

  // Update active tab when isAI prop or isPro status changes
  useEffect(() => {
    if (isAI && isPro) {
      setActiveTab("ai")
    } else {
          ...
          {isPro ? (
            ...
            <div className="bg-background-90 p-6 rounded-lg border border-background-80 text-center">
              <div className="flex flex-col items-center justify-center">
                ...
                <Button className="bg-white text-black hover:bg-gray-200" onClick={() => setShowPaymentPopup(true)}>
                  Upgrade to PRO
                </Button>
              </div>
            </div>
