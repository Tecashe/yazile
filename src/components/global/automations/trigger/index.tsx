...
const Trigger = ({ id }: Props) => {
  ...
  const handleSaveTrigger = () => {
    const currentKeywords = data?.data?.keywords?.map(k => k.word) || []
    onSaveTrigger({ listenMode, keywords: currentKeywords })
    setActiveTab("configure")
  }
  ...
  // Show active trigger if already configured
  if (data?.data && data?.data?.trigger.length > 0 && !isEditing) {
    return (
      <div className="flex flex-col items-center w-full">
        <ActiveTrigger
          ...
          <div className="relative m-[2px] bg-background-90 rounded-lg p-5">
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-[#768BDD] font-bold">
                {isEditing ? "Update automation" : "Configure automation"}
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="configure" className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium mb-2">Choose Response Mode</h3>
                <p className="text-sm text-slate-400">
                  Decide when your automation should respond to messages
                </p>
              </div>
                ...
                <Card
                  className={cn(
                    ...
                    listenMode === "KEYWORDS"
                      ...
                      : "bg-background-80 hover:bg-background-70 border-slate-700",
                  )}
                  onClick={() => setListenMode("KEYWORDS")}
                >
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-white">Keyword Triggers</h4>
                            <Badge 
                              variant="outline" 
                              className="mt-1 bg-green-500/20 text-green-300 text-xs border-green-500/30"
                            >
                              Recommended
                            </Badge>
                          </div>
                      ...
                      <p className="text-sm text-slate-300">
                        Only respond when customers use your specific keywords
                      </p>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-center gap-2 text-xs text-slate-400">
                          <div className="w-1 h-1 bg-green-400 rounded-full"></div>
                          <span>No unwanted responses</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-slate-400">
                          <div className="w-1 h-1 bg-green-400 rounded-full"></div>
                          <span>Best for specific workflows</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-white">All Messages</h4>
                            <Badge 
                              variant="outline" 
                              className="mt-1 bg-purple-500/20 text-purple-300 text-xs border-purple-500/30"
                            >
                              AI-Powered
                            </Badge>
                          </div>
                      ...
                      <p className="text-sm text-slate-300">
                        Respond to every message using AI naturally
                      </p>
            ...
            {listenMode === "KEYWORDS" ? (
              <div className="space-y-4">
                <Alert className="bg-blue-500/10 border-blue-500/30">
                  ...
                  <AlertTitle className="text-blue-300 font-medium">Keyword Mode</AlertTitle>
                  <AlertDescription className="text-slate-300">
                    Your automation will only trigger when messages contain your defined keywords.
                    Messages without keywords will be ignored unless you have another automation to handle them.
                  </AlertDescription>
                </Alert>

                <div>
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-base font-semibold text-white">Configure Keywords</h3>
                    <KeywordsPopup
                      id={id}
                      trigger={
                        <Button variant="outline" size="sm">
                  ...
                  <div className="flex flex-wrap gap-2 min-h-[80px] p-4 bg-background-80 rounded-lg border-2 border-dashed border-muted-foreground/20">
                    {hasKeywords ? (
                      currentKeywords.map((keywordObj) => (
                        <Badge 
                          key={keywordObj.id} 
                          className="bg-[#3352CC] text-white px-3 py-1"
                        >
                          {keywordObj.word}
                        </Badge>
                      ))
                  ...
                  {hasKeywords && (
                    <div className="flex items-start gap-2 mt-3 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                      <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-slate-300">
                        <span className="font-medium text-green-400">{currentKeywords.length} keywords active.</span>{" "}
                        Automation triggers when customers mention: {currentKeywords.map(k => k.word).join(", ")}
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="space-y-4">
                <Alert className="bg-purple-500/10 border-purple-500/30">
                  ...
                  <AlertTitle className="text-purple-300 font-medium">All Messages Mode</AlertTitle>
                  <AlertDescription className="text-slate-300">
                    Your automation will respond to every customer message using AI. Perfect for natural 
                    conversations. Make sure to configure your business profile for accurate responses.
                  </AlertDescription>
                </Alert>

                <div className="p-4 bg-background-80 rounded-lg border border-slate-700">
                  <div className="flex items-start gap-3">
                    <div className="p-2 bg-purple-500/10 rounded-lg">
                      <MessageSquare className="h-5 w-5 text-purple-400" />
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-medium text-white text-sm">What this means:</h4>
                      <ul className="space-y-1 text-sm text-slate-300">
                        <li className="flex gap-2">
                          <span className="text-purple-400">•</span>
                          <span>Every DM receives an AI response</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-purple-400">•</span>
                          <span>Conversations continue naturally over days</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-purple-400">•</span>
                          <span>No keywords required</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <Button
              ...
              disabled={types?.length === 0 || (listenMode === "KEYWORDS" && !hasKeywords)}
              className={cn(
                "w-full py-6 text-white font-medium",
                types?.length === 0 || (listenMode === "KEYWORDS" && !hasKeywords)
                  ? "bg-in-active"
            ...
            >
              <Loader state={isPending}>
                {isEditing ? "Update Automation" : "Save Configuration"}
              </Loader>
            </Button>
          </TabsContent>
