...
import { Badge } from "@/components/ui/badge"
import { MessageSquare, MousePointer, GitBranch, Clock, Zap, Webhook, Play, Palette, Image, Settings, Brain, Workflow } from "lucide-react"
          ...
          {blockTypes.map((category) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg border border-border bg-background hover:bg-accent hover:border-accent-foreground/20 transition-all duration-200 cursor-pointer">
                ...
                {/* Expanded Blocks on Hover */}
                {isHovered && (
                  <div className="absolute left-full top-0 ml-2 z-50 w-64 bg-background border border-border rounded-lg shadow-lg p-3 space-y-2">
                    ...
                    {category.blocks.map((block) => {
                      ...
                      return (
                        <div
                          ...
                          draggable
                          onDragStart={(e) => handleDragStart(e, block.type)}
                          className="group p-2 rounded-md border border-border bg-background hover:bg-accent hover:border-accent-foreground/20 cursor-grab active:cursor-grabbing transition-all duration-200"
                        >
                          <div className="flex items-center gap-2">
                            <div
