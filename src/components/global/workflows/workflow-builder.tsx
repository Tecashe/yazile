...
export function WorkflowBuilder({ workflowId, onBackToDashboard }: WorkflowBuilderProps) {
  const { sidebarCollapsed, rightPanelCollapsed } = useWorkflowStore()

  return (
    <div className="h-screen flex flex-col bg-background">
      <div className="flex-shrink-0 z-50 border-b border-border">
        <WorkflowHeader workflowId={workflowId} onBackToDashboard={onBackToDashboard} />
      </div>
