...
//   const handleConnectionStart = (e: React.MouseEvent, handle?: string) => {
//     e.stopPropagation()
...
//   const handleConnectionEnd = (e: React.MouseEvent, handle?: string) => {
//     e.stopPropagation()
//     if (connectionMode.active && connectionMode.fromNodeId && connectionMode.fromNodeId !== node.id) {
//       connectNodes(connectionMode.fromNodeId, node.id, connectionMode.fromHandle, handle)
//     }
//   }
...
//                   connectionMode.active && connectionMode.fromNodeId === node.id && connectionMode.fromHandle === "true"
...
//                   connectionMode.fromNodeId === node.id &&
//                   connectionMode.fromHandle === "false"
...
//               }`}
//               onClick={(e) => handleConnectionStart(e)}
