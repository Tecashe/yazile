...
//                       {template.icon ? (
//                         // <span className="text-xl">{template.icon}</span>
//                         <span className="text-xs">Cashe</span>
...
import { AnimatedSelectButton } from "./animated-select-button"
import { TemplateNameBadge } from "./template-name-badge"
          ...
          {templates.map((template, index) => (
            ...
            >
              ...
              >
                ...
                <CardContent className="p-4 relative z-10">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      <TemplateNameBadge name={template.name} category={template.category} />
                      <TemplateDescriptionModal title={template.name} description={template.description} />
                    </div>
                    <p className="text-sm text-muted-foreground line-clamp-2 group-hover:text-foreground/80 transition-colors">
                      {template.description}
                    </p>
                ...
                >
                  <AnimatedSelectButton onClick={() => onSelectTemplate(template.id)} />
                </div>
              </Card>
            </motion.div>
          ))}
