  ...
  return (
    <section ref={containerRef} className="py-32 bg-neutral-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div className="max-w-5xl mx-auto" style={{ y, scale, rotate }}>
          <motion.div
            className="relative bg-neutral-800 rounded-[3rem] p-1 shadow-2xl border-2 border-cyan-500/30"
            whileHover={{ scale: 1.02 }}
            transition={{ duration: 0.3 }}
          >
            {/* Inner content */}
            <div className="bg-neutral-900 rounded-[2.8rem] p-12 md:p-16 relative overflow-hidden">
              {/* Decorative elements */}
              <motion.div
                className="absolute top-10 right-10 w-32 h-32 bg-cyan-500/10 rounded-full blur-2xl"
                animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3] }}
              ...
              <div className="relative text-center">
                {/* Badge */}
                <motion.div
                  className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 rounded-full mb-8"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  whileHover={{ scale: 1.05 }}
                >
                  ...
                  <span className="font-medium text-neutral-300">Limited Time Offer</span>
                ...
                >
                  Ready to Transform Your
                  <span className="block mt-2 text-cyan-400">Instagram DMs?</span>
                </motion.h2>

                <motion.p
                  className="text-xl md:text-2xl text-neutral-400 mb-12 max-w-3xl mx-auto"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: 0.2 }}
                ...
                >
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button
                      size="lg"
                      className="bg-cyan-500 hover:bg-cyan-600 text-white px-12 py-8 text-xl rounded-full shadow-2xl shadow-cyan-500/30"
                    >
                      Start Free Trial
                      <ArrowRight className="ml-2 w-6 h-6" />
                    </Button>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button
                      size="lg"
                      variant="outline"
                      className="px-12 py-8 text-xl rounded-full border-2 border-neutral-700 hover:border-neutral-600 bg-transparent text-neutral-300"
                    >
                      Schedule Demo
                    </Button>
                  </motion.div>
                ...
                {/* Trust indicators */}
                <motion.div
                  className="flex flex-wrap justify-center items-center gap-8 text-sm text-neutral-400"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  viewport={{ once: true }}
                  transition={{ delay: 0.4 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {[
              ...
              <motion.div
                key={i}
                className="bg-neutral-800 rounded-2xl p-6 shadow-lg border-2 border-neutral-700 text-center hover:border-cyan-500/50 transition-colors"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.5 + i * 0.1 }}
