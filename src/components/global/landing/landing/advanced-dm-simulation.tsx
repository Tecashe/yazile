          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="relative order-2 lg:order-1">
              <div className="bg-card border-4 border-border rounded-3xl overflow-hidden shadow-2xl">
                {/* Header */}
                <div className="bg-muted px-4 py-4 border-b border-border flex items-center gap-3">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-orange flex items-center justify-center shadow-logo">
                    <ShoppingBag className="w-5 h-5 md:w-6 md:h-6 text-primary-foreground" />
                  </div>
                  <div>
                    <p className="font-semibold text-sm md:text-base text-foreground">Luxury Boutique</p>
                    <p className="text-xs text-green flex items-center gap-1">
                      <span className="w-2 h-2 bg-green rounded-full animate-pulse" />
                      Active now
                    </p>
                ...
                {/* Chat Area */}
                <div className="p-4 md:p-6 space-y-4 min-h-[400px] md:min-h-[500px] lg:min-h-[600px] relative bg-gradient-to-b from-background/50 to-background/80">
                  {/* Step 1: Welcome Message */}
                  {step >= 1 && (
                    <div className="flex gap-2 md:gap-3 animate-slide-in-left">
                      <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-orange flex items-center justify-center flex-shrink-0 shadow-logo">
                        <ShoppingBag className="w-4 h-4 md:w-5 md:h-5 text-primary-foreground" />
                      </div>
                      <div className="bg-muted rounded-2xl rounded-tl-sm px-3 md:px-5 py-2 md:py-3 max-w-[85%] border border-border/50">
                  ...
                  {step >= 2 && (
                    <div className="flex gap-2 md:gap-3 animate-fade-in">
                      <div className="w-8 md:w-10 flex-shrink-0" />
                      <div className="space-y-3 flex-1">
                        <div className="bg-muted rounded-2xl rounded-tl-sm px-3 md:px-5 py-2 md:py-3 border border-border/50">
                          <p className="text-xs md:text-sm text-foreground">Check out our bestsellers! 🔥</p>
                        </div>
                        ...
                        {products.map((product, index) => (
                          <div
                            ...
                            className={`bg-card border-2 ${
                              selectedProduct === index 
                                ? "border-green scale-105 shadow-lg" 
                                : "border-border"
                            } rounded-2xl p-3 md:p-4 transition-all duration-300 cursor-pointer hover:border-green/50 hover:scale-[1.02]`}
                          >
                            <div className="flex items-center gap-3 md:gap-4">
                              {/* Product Image/Emoji */}
                              <div className={`w-14 h-14 md:w-20 md:h-20 ${product.color} rounded-xl flex items-center justify-center flex-shrink-0 text-3xl md:text-4xl shadow-md`}>
                                {product.emoji}
                              </div>
                              
                              {/* Product Info */}
                              <div className="flex-1 min-w-0">
                                <p className="font-semibold text-xs md:text-base truncate text-foreground">
                                  {product.name}
                                </p>
                                <p className="text-xs md:text-sm text-muted-foreground">{product.price}</p>
                                <button className="mt-1 md:mt-2 text-xs bg-green text-primary-foreground px-2 md:px-4 py-1 md:py-1.5 rounded-full font-medium hover:bg-green/90 transition-colors shadow-sm">
                                  Add to Cart
                                </button>
                              </div>
                              ...
                              {/* Selected Check */}
                              {selectedProduct === index && (
                                <Check className="w-4 h-4 md:w-6 md:h-6 text-green flex-shrink-0 animate-scale-in" />
                              )}
                            </div>
                          </div>
                        ))}
                  ...
                  {step >= 3 && (
                    <div className="flex gap-3 justify-end animate-slide-in-right">
                      <div className="bg-orange rounded-2xl rounded-tr-sm px-3 md:px-5 py-2 md:py-3 max-w-[85%] shadow-md">
                        <p className="text-xs md:text-sm text-primary-foreground font-medium">
                          I&apos;ll take the Designer Handbag!
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {step >= 4 && (
                    <div className="flex gap-2 md:gap-3 animate-slide-in-left">
                      ...
                      <div className="bg-muted rounded-2xl rounded-tl-sm px-3 md:px-5 py-2 md:py-3 max-w-[85%] border border-border/50">
                        <p className="text-xs md:text-sm mb-3 text-foreground">Excellent choice! ✨ Added to your cart.</p>
                        <div className="bg-card border-2 border-orange/30 rounded-xl p-3 flex items-center justify-between shadow-md">
                          <div className="flex items-center gap-2 md:gap-3">
                            <Package className="w-4 h-4 md:w-5 md:h-5 text-orange" />
                            <div>
                              <p className="text-xs font-semibold text-muted-foreground">Cart Total</p>
                              <p className="text-sm md:text-base font-bold text-orange">$299</p>
                            </div>
                          </div>
                          <button className="bg-orange text-primary-foreground px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-xs font-semibold hover:bg-orange/90 transition-all hover:scale-105 shadow-sm flex items-center gap-2">
                            <CreditCard className="w-3 h-3 md:w-4 md:h-4" />
                            Checkout
                          </button>
                        </div>
                  ...
                  {step >= 6 && (
                    <div className="flex gap-2 md:gap-3 animate-slide-in-left">
                      <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-green flex items-center justify-center flex-shrink-0 shadow-md">
                        <Check className="w-4 h-4 md:w-5 md:h-5 text-primary-foreground" />
                      </div>
                      <div className="bg-green/20 border-2 border-green rounded-2xl rounded-tl-sm px-3 md:px-5 py-2 md:py-3 max-w-[85%] shadow-md">
                        <p className="text-xs md:text-sm font-medium text-green">
                          🎉 Order confirmed! You&apos;ll receive tracking info shortly. Thanks for shopping with us!
                        </p>
                      </div>
                  ...
                  {showCursor && (
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        className="drop-shadow-2xl md:w-7 md:h-7 animate-scale-in"
                      >
                        <path
                          d="M3 3L10.07 19.97L12.58 12.58L19.97 10.07L3 3Z"
                          fill="#ff6b35"
            ...
            <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
              <div className="space-y-4 lg:space-y-6">
                <div className="flex items-start gap-3 md:gap-4 scroll-reveal">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-orange/10 rounded-xl flex items-center justify-center flex-shrink-0 border border-orange/20">
                    <span className="text-xl md:text-2xl font-bold text-orange">1</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 md:gap-4 scroll-reveal">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-green/10 rounded-xl flex items-center justify-center flex-shrink-0 border border-green/20">
                    <span className="text-xl md:text-2xl font-bold text-green">2</span>
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 text-foreground">
                ...
                <div className="flex items-start gap-3 md:gap-4 scroll-reveal">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-purple/10 rounded-xl flex items-center justify-center flex-shrink-0 border border-purple/20">
                    <span className="text-xl md:text-2xl font-bold text-purple">3</span>
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 text-foreground">
                ...
                <div className="flex items-start gap-3 md:gap-4 scroll-reveal">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-red/10 rounded-xl flex items-center justify-center flex-shrink-0 border border-red/20">
                    <span className="text-xl md:text-2xl font-bold text-red">4</span>
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 text-foreground">
              ...
              {/* Stats Card */}
              <div className="bg-card border-2 border-orange/20 rounded-2xl p-4 md:p-6 shadow-lg scroll-reveal">
                <p className="text-xs md:text-sm text-muted-foreground mb-2">Average conversion rate</p>
                <p className="text-3xl md:text-4xl font-bold text-orange mb-2">34.7%</p>
