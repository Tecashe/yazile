      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white">
            See Yazzil in
            <span className="block mt-2 text-cyan-400">Action</span>
          </h2>
          ...
          <motion.div className="relative group" whileHover={{ scale: 1.02 }} transition={{ duration: 0.4 }}>
            ...
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl bg-neutral-900">
              ...
              <div className="aspect-video bg-neutral-800 flex items-center justify-center">
                <img
                  src="/yazzil-instagram-dm-automation-demo-dashboard-inte.jpg"
                  alt="Yazzil Demo"
            ...
            {/* Floating stats */}
            <motion.div
              className="absolute -left-8 top-1/4 bg-neutral-800 rounded-2xl p-6 shadow-xl border-2 border-cyan-500/20"
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.3 }}
            ...
            <motion.div
              className="absolute -right-8 bottom-1/4 bg-neutral-800 rounded-2xl p-6 shadow-xl border-2 border-orange-500/20"
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.5 }}
            ...
            >
              ...
              <div className="text-sm text-neutral-400">ROI Average</div>
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        >
          {[
            ...
            <motion.div
              key={i}
              className="bg-neutral-900 rounded-2xl p-6 shadow-lg border-2 border-neutral-800 text-center hover:border-cyan-500/50 transition-colors"
              whileHover={{ y: -10 }}
            >
              <div className="text-2xl font-bold mb-2 text-white">{feature.title}</div>
