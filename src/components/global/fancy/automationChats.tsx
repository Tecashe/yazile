  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-background border border-border rounded-lg max-w-4xl max-h-[90vh] overflow-hidden w-full"
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">DeepSeek-powered insights and recommendations</p>
              </div>
            </div>
